...
public class Practical_5
{
    public static void main(String[] args) {
        ...
        AIML aiml = new AIML("Prajwal Bhopre", "Vedant Shende", "Peeyush Kaware", "Bhavesh More", "Samarth Sharma");
        AIDS aids = new AIDS("Prajwal Bhopre", "Vedant Shende", "Peeyush Kaware", "Bhavesh More", "Samarth Sharma");
        CSE cse = new CSE("Prajwal Bhopre", "Vedant Shende", "Peeyush Kaware", "Bhavesh More", "Samarth Sharma");
